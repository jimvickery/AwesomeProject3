...
Get the connection to the Sillysnap API
Setup authentication using connection string to connect to DB and use username and password. Will be using this tutorial: https://www.youtube.com/watch?v=ZpiF5IhavaY&index=1&list=PLkdLxQVsHYXxteWDEgOODl_UcRaa4x6t6
